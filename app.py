...
def seccion_finanzas():
    ...
    with bloque_cp:
        ...
        # Subsección 1.5: Deuda y Liquidez
    ...
    with bloque_lp:
        ...
        if tasas_rows:
            ...
            mostrar(fig_tasas)
            st.caption('Tasas más altas en general reflejan menor calificación crediticia — se pueden comparar directo contra la calificación del Corto Plazo.')
