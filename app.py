...
def mostrar(fig, ocultar_eje_valores=None, en_card=True, **kwargs):
    ...
    altura = fig.layout.height or (CHART_HEIGHT + 130 if leyenda_abajo else CHART_HEIGHT)
    margen_b = 130 if leyenda_abajo else 20
    color_linea_eje = 'rgba(128,128,128,0.3)'
...
def linea_media(fig, valor, eje='y', etiqueta='Promedio'):
    ...
    color_ref = 'rgba(128,128,128,0.6)'
    ...
    with tab_lp:
        ...
        if sum(activo_items.values()) > 0:
            ...
            fig_bal.update_layout(
                ...
                legend=dict(orientation='h', title='Activo', x=0, y=-0.15, xanchor='left', yanchor='top'),
                legend2=dict(orientation='h', title='Pasivo + PN', x=0, y=-0.35, xanchor='left', yanchor='top'),
